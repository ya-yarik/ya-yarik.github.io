...
kc&&(jc=kc?kc[1]:"");if(dc){var lc=hc();if(null!=lc&&lc>parseFloat(jc)){ic=String(lc);break a}}ic=jc}var mc=ic,nc;if(z.document&&dc){var oc=hc();nc=oc?oc:parseInt(mc,10)||void 0}else nc=void 0;var pc=nc;var qc=ac()||F("iPod"),rc=F("iPad");!F("Android")||Lb();Lb();var sc=F("Safari")&&!(Lb()||F("Coast")||F("Opera")||F("Edge")||F("Edg/")||F("OPR")||F("Firefox")||F("FxiOS")||F("Silk")||F("Android"))&&!(ac()||F("iPad")||F("iPod"));var uc={},vc=null;function wc(a,b){Ma(a);void 0===b&&(b=0);xc();b=uc[b];for(var c=Array(Math.floor(a.length/3)),d=b[64]||"",e=0,f=0;e<a.length-2;e+=3){var g=a[e],h=a[e+1],k=a[e+2],l=b[g>>2];g=b[(g&3)<<4|h>>4];h=b[(h&15)<<2|k>>6];k=b[k&63];c[f++]=""+l+g+h+k}l=0;k=d;switch(a.length-e){case 2:l=a[e+1],k=b[(l&15)<<2]||d;case 1:a=a[e],c[f]=""+b[a>>2]+b[(a&3)<<4|l>>4]+k+d}return c.join("")}
...
function gl(a){function b(){var f,g,h,k,l,m,n,r,q,x;return y(function(A){switch(A.h){case 1:return g=null!=(f=Error().stack)?f:"",wa(A,2),w(A,a.j(a.name,a.options.version,d),4);case 4:h=A.i;for(var H=a.options,K=[],M=u(Object.keys(H.da)),O=M.next();!O.done;O=M.next()){O=O.value;var ob=H.da[O],tc=void 0===ob.Ab?Number.MAX_VALUE:ob.Ab;!(h.h.version>=ob.ga)||h.h.version>=tc||h.h.objectStoreNames.contains(O)||K.push(O)}k=K;if(0===k.length){A.s(5);break}l=Object.keys(a.options.da);m=h.objectStoreNames();
...
;function Kl(){}
function Ll(a,b,c){var d,e,f,g;return y(function(h){if(1==h.h){if(!R("gcf_config_store_update_enabled"))return h.s(0);c&&(a.h=c,B("yt.gcf.config.hotConfigGroup",a.h));a.hotHashData=b;B("yt.gcf.config.hotHashData",a.hotHashData);d=ql();return d?c?h.s(4):w(h,Jl(d),5):(e=Jj("updateHotConfig token error"),ai(e),h.s(0))}4!=h.h&&(f=h.i,c=null==(g=f)?void 0:g.config);return w(h,Gl(c,b,d),0)})}
function Ml(a,b,c){var d,e,f,g,h;return y(function(k){if(1==k.h){if(!R("gcf_config_store_update_enabled"))return k.s(0);a.coldHashData=b;B("yt.gcf.config.coldHashData",a.coldHashData);d=ql();return d?c?k.s(4):w(k,Il(d),5):(e=Jj("updateColdConfig token error"),ai(e),k.s(0))}4!=k.h&&(f=k.i,c=null==(g=f)?void 0:g.config);if(!c)return k.s(0);h=c.configData;return w(k,Hl(c,b,h,d),0)})}
...
a?wn.i=b:vn.i=b}
function On(a,b,c,d,e,f){e=void 0===e?{}:e;var g=Math.round(U()),h=a.size,k={};a=u(a);for(var l=a.next();!l.done;k={na:k.na,U:k.U,fa:k.fa,pa:k.pa,oa:k.oa},l=a.next()){var m=u(l.value);l=m.next().value;m=m.next().value;k.U=mb({context:Pl(b.config_||Ol())});if(!Ma(m)&&!R("throw_err_when_logevent_malformed_killswitch")){d();break}k.U.events=m;(m=Bn[l])&&Sn(k.U,l,m);delete Bn[l];k.fa="visitorOnlyApprovedKey"===l;Tn(k.U,g,k.fa);Un(e);k.pa=function(n){R("update_log_event_config")&&We.L(function(){return y(function(r){return w(r,
Vn(n),0)})});
h--;h||c()};
...
K=x.stack||r.i||"Not available";if(K.startsWith(H+": "+A)){var M=K.split("\n");M.shift();K=M.join("\n")}var O=x.lineNumber||"Not available",ob=x.fileName||"Not available",tc=K,Aa=0;if(r.hasOwnProperty("args")&&r.args&&r.args.length)for(var ra=0;ra<r.args.length&&!(Aa=Zi(r.args[ra],"params."+ra,q,Aa),500<=Aa);ra++);else if(r.hasOwnProperty("params")&&r.params){var X=r.params;if("object"===typeof r.params)for(n in X){if(X[n]){var ca="params."+n,da=aj(X[n]);q[ca]=da;Aa+=ca.length+da.length;if(500<Aa)break}}else q.params=
aj(X)}if(no.length)for(var W=0;W<no.length&&!(Aa=Zi(no[W],"params.context."+W,q,Aa),500<=Aa);W++);navigator.vendor&&!q.hasOwnProperty("vendor")&&(q["device.vendor"]=navigator.vendor);var S={message:A,name:H,lineNumber:O,fileName:ob,stack:tc,params:q,sampleWeight:1},ak=Number(r.columnNumber);isNaN(ak)||(S.lineNumber=S.lineNumber+":"+ak);if("IGNORED"===r.level)m=0;else a:{for(var bk=Vi(),ck=u(bk.T),Zf=ck.next();!Zf.done;Zf=ck.next()){var dk=Zf.value;if(S.message&&S.message.match(dk.dc)){m=dk.weight;
...
go("appCrashed",qk)}lo++}else"WARNING"===h&&Wi.ea("handleWarning",ua);if(R("kevlar_gel_error_routing"))a:{var fg=void 0,gg=void 0,Mc=h,Q=ua;if(R("errors_via_jspb")){if(po())gg=void 0;else{var Vb=new yh;I(Vb,1,Q.stack);Q.fileName&&I(Vb,4,Q.fileName);var Na=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Na.length&&(1!==Na.length||isNaN(Number(Na[0]))?2!==Na.length||isNaN(Number(Na[0]))||isNaN(Number(Na[1]))||(I(Vb,2,Number(Na[0])),I(Vb,3,Number(Na[1]))):I(Vb,2,Number(Na[0])));var ub=
...
Fk&&Gk&&(Wb.kvPairs.push({key:"server.name",value:Fk}),Wb.kvPairs.push({key:"server.version",value:Gk}));fg={errorMetadata:Wb,stackTrace:So,logMessage:pg}}var Hk=fg;if(!Hk)break a;go("clientError",Hk)}if("ERROR"===Mc||R("errors_flush_gel_always_killswitch"))b:{if(R("web_fp_via_jspb")&&(co(!0),!R("web_fp_via_jspb_and_json")))break b;co()}}if(!R("suppress_error_204_logging")){var yb=ua,Oc=yb.params||{},$a={urlParams:{a:"logerror",t:"jserror",type:yb.name,msg:yb.message.substr(0,250),line:yb.lineNumber,
level:h,"client.name":Oc.name},postParams:{url:P("PAGE_NAME",window.location.href),file:yb.fileName},method:"POST"};Oc.version&&($a["client.version"]=Oc.version);if($a.postParams){yb.stack&&($a.postParams.stack=yb.stack);for(var Ik=u(Object.keys(Oc)),sg=Ik.next();!sg.done;sg=Ik.next()){var Jk=sg.value;$a.postParams["client."+Jk]=Oc[Jk]}var tg=Vh();if(tg)for(var Kk=u(Object.keys(tg)),ug=Kk.next();!ug.done;ug=Kk.next()){var Lk=ug.value;$a.postParams[Lk]=tg[Lk]}var Mk=P("SERVER_NAME"),Nk=P("SERVER_VERSION");
Mk&&Nk&&($a.postParams["server.name"]=Mk,$a.postParams["server.version"]=Nk)}Hi(P("ECATCHER_REPORT_HOST","")+"/error_204",$a)}try{jo.add(ua.message)}catch(Xo){}ko++}}}}}else throw Tb;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function Lo(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
