...
;function Xn(a,b){var c=void 0===c?{}:c;if(R("migrate_events_to_ts")){c=void 0===c?{}:c;var d=Jm;P("ytLoggingEventsDefaultDisabled",!1)&&Jm===Jm&&(d=null);R("web_all_payloads_via_jspb")?Un.push({fc:a,payload:b,options:c}):Rn(a,b,d,c)}else d=Jm,P("ytLoggingEventsDefaultDisabled",!1)&&Jm==Jm&&(d=null),Rn(a,b,d,c)}
